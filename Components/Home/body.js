...
export default function Body(){
    ...
    return(
        <div className="grid md:grid-cols-2 lg:grid-cols-2 pt-6 pb-6 pl-4 lg:pl-20 pr-4">
            <div>
                <h1 className="font-semibold text-[35px] md:text-[45px] lg:text-[60px]">Welcome to <span className="bg-gradient-to-r from-[#11e3fb] to-[#5be6ff] text-transparent bg-clip-text">KodeinKGP</span></h1>
                <p className="ld:text-lg mt-4 mb-4 text-gray-400">“The Web as I envisaged it, we have not seen it yet. The future is still so much bigger than the past”</p>
