...
export default function Desc(){
    ...
    return(
        <div>
            ...
            <div className="grid grid-cols-4 font-semibold text-[25px] pl-20 pt-10 pb-10">
                <div>
            ...
            <div>
                <div className="flex justify-center align-middle">
                    <h2 className="m-4 font-semibold text-5xl bg-gradient-to-r from-[#11e3fb] to-[#ffff] text-transparent bg-clip-text">Our Expertise</h2>
                </div>

                <div className="grid grid-cols-3 ">
                    <div className="flex flex-col justify-center align-middle resize bg-[rgb(20,20,50)] p-5 rounded-xl m-5 h-[40vw] hover:duration-500 hover:bg-[rgb(30,30,50)] delay-200">
                        <Image
            ...
            <div className="p-5 mt-6 mb-6 ml-20 mr-20 bg-[rgb(20,20,50)] cursor-pointer grid grid-cols-2 rounded-2xl hover:duration-500 hover:bg-[rgb(30,30,50)] delay-200"
                onClick={()=>{
                    router.push("/pds")
                }}>
                <div className="flex flex-col justify-center align-middle">
                    <span className="2xl font-semibold text-[30px] bg-gradient-to-r from-[#11e3fb] to-[#5be6ff] text-transparent bg-clip-text">Still Getting Stuck in PDS?</span>
